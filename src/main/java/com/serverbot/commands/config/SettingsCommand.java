...
public class SettingsCommand implements SlashCommand {
                ...
                return new EmbedBuilder()
                                ...
                                .addField("\uD83C\uDFAE  Features",
                                                (economy ? on : off) + " Economy   " +
                                                                ...
                                                                (dmNotify ? on : off) + " DM Notifications",
                                                false)
                                .addField("\uD83D\uDCB0  Economy",
                                ...
                                .addField("\uD83D\uDEE1\uFE0F  Moderation",
                                                "Max Warnings: **" + maxWarnings + "**  |  Expiry: **" + warnExpiry
                                                                + " days**",
                                                false)
        ...
        public static List<ActionRow> buildPanelRows(Map<String, Object> settings, String uid) {
                ...
                return List.of(
                                ...
                                ActionRow.of(
                                                Button.secondary("sgui:daily-reward:" + uid, "Daily Reward")
                                                                .withEmoji(Emoji.fromUnicode("\uD83D\uDCB0")),
                                                Button.secondary("sgui:work-reward:" + uid, "Work Reward")
                                                                .withEmoji(Emoji.fromUnicode("\uD83D\uDCBC")),
                                                Button.secondary("sgui:work-cooldown:" + uid, "Work Cooldown")
                                                                .withEmoji(Emoji.fromUnicode("\u23F0")),
                                                Button.secondary("sgui:points-per-msg:" + uid, "Points/Msg")
                                                                .withEmoji(Emoji.fromUnicode("\uD83D\uDCCA")),
                                                Button.secondary("sgui:xp-per-msg:" + uid, "XP/Msg")
                                                                .withEmoji(Emoji.fromUnicode("\uD83D\uDCC8"))),
                                ActionRow.of(
                                                Button.secondary("sgui:max-warnings:" + uid, "Max Warnings")
                                                                .withEmoji(Emoji.fromUnicode("\u26A0\uFE0F")),
                                                Button.secondary("sgui:warn-expiry:" + uid, "Warn Expiry")
                                                                .withEmoji(Emoji.fromUnicode("\uD83D\uDCC5")),
        ...
        public void handleLogChannel(SlashCommandInteractionEvent event) {
                ...
                if (opt == null) {
                        ServerBot.getStorageManager().updateGuildSettings(event.getGuild().getId(), "logChannelId",
                                        null);
        ...
        public String getDescription() {
                return "Configure server settings \u2014 run with no args for the GUI panel";
        }
                ...
                return Commands.slash("settings",
                                ...
                                .addOptions(
                                                ...
                                                new OptionData(OptionType.INTEGER, "value",
                                                                "Numeric value (for reward/cooldown/warning settings)",
                                                                false),
